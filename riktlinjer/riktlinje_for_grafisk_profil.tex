...
\begin{table}[!hbp]
    ...
    \begin{tabular}{ll}
        ...
        Första rubriknivån (x)                    & {\sffamily \bfseries \TeX\ Gyre Heros}, 14 pt \\
        Andra rubriknivån (x.y)                   & {\sffamily \bfseries \TeX\ Gyre Heros}, 12 pt \\
        Tredje rubriknivån (x.y.z)                & {\sffamily \bfseries \TeX\ Gyre Heros}, 11 pt \\
        Tabell- och figurbeskrivningar (captions) & \textit{Domitian kursiv}, 9 pt             \\
